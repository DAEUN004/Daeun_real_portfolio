          ...
          <DetailContainer>
            <DetailWrap imgurl={projectDetail.imgurl}>
              ...
              <Btns>
                ...
                <ContBtns>
                  {projectDetail.giturl && <LinkBtn name='github' giturl={projectDetail.giturl} text='GitHub' />}
              ...
              <DetailBody>
                ...
                </ProjectInfoTxt>
                {
                  projectDetail.featinfo.length !== 0 && (
                    <PWrap>
                      <PTitle>📍 Key Features and Characteristics</PTitle>
                      <PDetailList>
                        {
                ...
                <PWrap>
                  <PTitle>
                    ...
                    <PSubText>Click to view the details.</PSubText>
                  </PTitle>
                  <Toggles>
                    {
...

                {
                  projectDetail.detailimginfo && (
                    <PWrap>
                      <PTitle>
                        💻 Deployment
                        <PSubText>Click to view a larger image.</PSubText>
                      </PTitle>
